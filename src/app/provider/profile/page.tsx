  ...
  return (
    <div className="px-4 py-4">
      ...
      <div className="mt-5 flex items-center gap-2 rounded-xl border bg-white p-4">
        ...
        <span className="text-sm text-muted-foreground">({t('provider.jobsCount').replace('{count}', String(profile.totalJobs))})</span>
      </div>
      ...
      <div className="mt-4 rounded-xl border bg-white p-4">
        <p className="font-semibold">{t('provider.areas')}</p>
        <div className="mt-2 flex flex-wrap gap-2">
      ...
      <div className="mt-4 rounded-xl border bg-white p-4 text-sm">
        <p className="font-semibold">{t('provider.workingHours')}</p>
      ...
      <div className="mt-4 rounded-xl border bg-white p-4 text-sm">
        <p className="font-semibold">{t('provider.payoutInfo')}</p>
        <p className="mt-1 text-muted-foreground">
          {t('provider.payoutNote')}
        </p>
      </div>

      <div className="mt-5">
        <RoleSwitch targetRole="customer" label={t('provider.switchToCustomerMode')} />
      </div>
